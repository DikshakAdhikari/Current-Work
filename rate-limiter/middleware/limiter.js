...
async function limiter( req, res, next){
       ...
       if(requests == 1){ //It means when exactly the very first request is made,
        await client.expire(ip, 60)  //Most imp line.. It tells that our key i.e. our ip address value will reset at every 60 seconds, that means at every 60 seconds the value of our key i.e. ip address will be 0
